...
func (e *UserEventsExchange) Listen() {
	e.wsManager.AddObserver(events.User.AssociateClient, e.handleClientAssociationRequest)
}

// [Client Event] - Request to associate a user with client
func (e *UserEventsExchange) handleClientAssociationRequest(m websockets.IncomingWebSocketMessage, c *websockets.Client) {
